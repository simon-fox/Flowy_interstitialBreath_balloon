...
.defines(function(){
	...
	IB2EntityWindSwirlParticle = ig.Entity.extend({
		//physical movement parameters
		animSheet: new ig.AnimationSheet( 'media/Wind_Twirl_128x64px_11f.png', 128, 64 ),
		size: {x:128, y:64},
		...
		init: function( x, y, settings ){
			...
			this.windVector = ig.game.getEntitiesByType( IB2EntityWindVector )[0];
